    ...
    <div className="dashboard-container">
      ...
      <AdminSidebar />
        ...
        <div className="card advanced">
            <i className="fas fa-users card-icon"></i> {/* Font Awesome Icon */}
            <h2>Active Users</h2>
            <p>250</p>
            <small>15 new users this week</small>
        </div>
        <div className="card advanced">
            <i className="fas fa-user-tie card-icon"></i> {/* Font Awesome Icon */}
            <h2>Supervisors</h2>
            <p>35</p>
            <small>2 added today</small>
        </div>
        <div className="card advanced">
            <i className="fas fa-project-diagram card-icon"></i> {/* Font Awesome Icon */}
            <h2>Projects</h2>
            <p>120</p>
            <small>10 new projects started</small>
        </div>
        <div className="card advanced">
            <i className="fas fa-file-alt card-icon"></i> {/* Font Awesome Icon */}
            <h2>Reports</h2>
            <p>45</p>
