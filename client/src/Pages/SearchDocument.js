        ...
        <div className="container">
          ...
          <section className="search-section">
            ...
            <div className="filters">
              ...
              <input type="date" className="filter" placeholder="Start Date" />
              <input type="date" className="filter" placeholder="End Date" />
            </div>
          </section>
          ...
          <section className="recent-activity">
            ...
            <ul className="activity-list">
              <li>Document "Machine Learning Trends" was approved on 2024-01-15.</li>
              <li>Proposal "Blockchain Security" is pending review by Dr. Jane Smith.</li>
              <li>Report "Data Privacy Insights" was rejected on 2024-01-10.</li>
            </ul>
          </section>
        </div>
      </div>
