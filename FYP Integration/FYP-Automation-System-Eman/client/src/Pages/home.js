...
const Home = () => {
  // Announcements displayed in the carousel
  const announcements = [
  ...
  return (
    <div className="home-container">
      ...
      {/* Hero section with title, description, and signup button */}
      ...
      <div className="home-content">
        ...
        <div className="main-content">
          ...
          <p>
            This system helps manage final year projects efficiently with features like proposal submission, 
            group management, and progress tracking.
          </p>
